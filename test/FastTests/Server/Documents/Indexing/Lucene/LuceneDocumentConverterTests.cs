...
namespace FastTests.Server.Documents.Indexing.Lucene
{
    public class LuceneDocumentConverterTests : RavenLowLevelTestBase
    {
        ...
        public void Returns_null_value_if_property_is_null()
        {
            ...
            bool shouldSkip;
            _sut.SetDocument(doc.Id, doc, _ctx, FakeWriteOperationBuffer.Create(), out shouldSkip);
        ...
        public void Reuses_cached_document_instance()
        {
            ...
            bool shouldSkip;
            _sut.SetDocument(doc1.Id, doc1, _ctx, FakeWriteOperationBuffer.Create(), out shouldSkip);
            ...
            _sut.SetDocument(doc2.Id, doc2, _ctx, FakeWriteOperationBuffer.Create(), out shouldSkip);
        ...
        public void Conversion_of_complex_value()
        {
            ...
            bool shouldSkip;
            using (_sut.SetDocument(doc.Id, doc, _ctx, FakeWriteOperationBuffer.Create(), out shouldSkip))
            {
                Assert.Equal(5, _sut.Document.GetFields().Count);
