...
namespace Voron.Platform.Posix
{
    public sealed unsafe class Posix32BitsMemoryMapPager : PosixAbstractPager
    {
        ...
        public Posix32BitsMemoryMapPager(StorageEnvironmentOptions options, VoronPathSetting file, long? initialFileSize = null,
            bool usePageProtection = false) : base(RavenLogManager.Instance.GetLoggerForVoron<Posix32BitsMemoryMapPager>(options, file?.FullPath), options, canPrefetchAhead: false, usePageProtection: usePageProtection, supportsUnmapping: false)
        {
            _options = options;
            FileName = file;
