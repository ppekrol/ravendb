...
{
    internal sealed class RevertRevisionsOperation : IMaintenanceOperation<OperationIdResult>
    {
        ...
        internal sealed class RevertRevisionsCommand : RavenCommand<OperationIdResult>
        {
