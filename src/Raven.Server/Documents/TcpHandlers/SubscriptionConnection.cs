...
namespace Raven.Server.Documents.TcpHandlers
{
    public class SubscriptionConnection : IDisposable
    {
        ...
        public SubscriptionConnection(TcpConnectionOptions connectionOptions, IDisposable tcpConnectionDisposable, MemoryBuffer bufferToCopy)
        {
        ...
        public static void SendSubscriptionDocuments(TcpConnectionOptions tcpConnectionOptions, MemoryBuffer buffer)
        {
        ...
        private readonly (IDisposable ReleaseBuffer, MemoryBuffer Buffer) _copiedBuffer;
