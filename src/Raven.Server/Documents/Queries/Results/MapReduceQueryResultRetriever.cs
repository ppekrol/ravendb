...
{
    internal sealed class MapReduceQueryResultRetriever : StoredValueQueryResultRetriever
    {
    ...
    internal abstract class StoredValueQueryResultRetriever : QueryResultRetrieverBase
    {
