...
namespace Raven.Server.Documents
{
    public sealed class BlittableMetadataModifier : IDisposable, IBlittableDocumentModifier
    {
        ...
        private unsafe LazyStringValue CreateLazyStringValueFromParserState(JsonParserState state)
        {
            ...
            Memory.Copy(mem.Address, state.StringBuffer.Address, state.StringSize);
        ...
        private unsafe bool AboutToReadPropertyNameInternal(UnmanagedJsonParser reader, JsonParserState state)
        {
            ...
            while (true)
            {
                ...
                if (_readingMetadataObject == false)
                {
                    if (state.StringSize == 9 && state.StringBuffer.Address[0] == (byte)'@' && *(long*)(state.StringBuffer.Address + 1) == 7022344802737087853)
        ...
        private unsafe bool AboutToReadPropertyNameInMetadataUnlikely(IJsonParser reader, JsonParserState state, out bool aboutToReadPropertyName)
        {
            ...
            switch (state.StringSize)
            {
                ...
                case 3: // @id
                    if (state.StringBuffer.Address[0] != (byte)'@' ||
                        *(short*)(state.StringBuffer.Address + 1) != 25705)
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 5: // @etag
                    if (state.StringBuffer.Address[0] != (byte)'@' ||
                        *(int*)(state.StringBuffer.Address + 1) != 1734440037)
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 6: // @flags
                    if (state.StringBuffer.Address[0] != (byte)'@' ||
                        *(int*)(state.StringBuffer.Address + 1) != 1734437990 ||
                        state.StringBuffer.Address[1 + sizeof(int)] != (byte)'s')
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 9: // @counters
                    ...
                    if (state.StringBuffer.Address[0] != (byte)'@' ||
                        *(long*)(state.StringBuffer.Address + 1) != 8318823012450529123)
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 11: // @timeseries
                    ...
                    if (state.StringBuffer.Address[0] != (byte)'@' ||
                        *(long*)(state.StringBuffer.Address + 1) != 7598247067624761716 ||
                        *(short*)(state.StringBuffer.Address + 1 + sizeof(long)) != 29541)
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 12: // @index-score OR @attachments
                    ...
                    if (state.StringBuffer.Address[0] == (byte)'@')
                    {   // @index-score
                        if (*(long*)(state.StringBuffer.Address + 1) == 7166121427196997225 &&
                            *(short*)(state.StringBuffer.Address + 1 + sizeof(long)) == 29295 &&
                            state.StringBuffer.Address[1 + sizeof(long) + sizeof(short)] == (byte)'e')
                        {
                            goto case -1;
                        }

                        // @attachments
                        if (*(long*)(state.StringBuffer.Address + 1) == 7308612546338255969 &&
                            *(short*)(state.StringBuffer.Address + 1 + sizeof(long)) == 29806 &&
                            state.StringBuffer.Address[1 + sizeof(long) + sizeof(short)] == (byte)'s')
                        {
                ...
                case 13: //Last-Modified
                    if (*(long*)state.StringBuffer.Address != 7237087983830262092 ||
                        *(int*)(state.StringBuffer.Address + sizeof(long)) != 1701406313 ||
                ...
                case 14:
                    ...
                    {
                        // @change-vector
                        if (*(long*)(state.StringBuffer.Address + 1) == 8515573965335390307 &&
                            *(int*)(state.StringBuffer.Address + 1 + sizeof(long)) == 1869898597 &&
                            state.StringBuffer.Address[1 + sizeof(long) + sizeof(int)] == (byte)'r')
                        {
                            if (reader.Read() == false)
                            {
                        ...
                        // @last-modified
                        if (*(long*)(state.StringBuffer.Address + 1) == 7237123168202350956 &&
                            *(int*)(state.StringBuffer.Address + 1 + sizeof(long)) == 1701406313 &&
                            state.StringBuffer.Address[1 + sizeof(long) + sizeof(int)] == (byte)'d')
                        {
                            if (reader.Read() == false)
                            {
                ...
                case 15: //Raven-Read-Only
                    if (*(long*)state.StringBuffer.Address != 7300947898092904786 ||
                        *(int*)(state.StringBuffer.Address + sizeof(long)) != 1328374881 ||
                        *(short*)(state.StringBuffer.Address + sizeof(long) + sizeof(int)) != 27758 ||
                        state.StringBuffer.Address[14] != (byte)'y')
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 17: //Raven-Entity-Name --> @collection
                    if (*(long*)state.StringBuffer.Address != 7945807069737017682 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long)) != 7881666780093245812 ||
                        state.StringBuffer.Address[16] != (byte)'e')
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                    ...
                    state.StringBuffer = collection.AllocatedMemoryData.Memory;
                    state.StringSize = collection.Size;
                    aboutToReadPropertyName = true;
                    return true;

                case 19: //Raven-Last-Modified or Raven-Delete-Marker
                    if (*(int*)state.StringBuffer.Address != 1702256978 ||
                        *(short*)(state.StringBuffer.Address + sizeof(int)) != 11630)
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }

                    var longValue = *(long*)(state.StringBuffer.Address + sizeof(int) + sizeof(short));
                    var intValue = *(int*)(state.StringBuffer.Address + sizeof(int) + sizeof(short) + sizeof(long));
                    ...
                    var lb = state.StringBuffer.Address[18];
                ...
                case 21: //Raven-Expiration-Date
                    if (*(long*)state.StringBuffer.Address != 8666383010116297042 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long)) != 7957695015158966640 ||
                        *(short*)(state.StringBuffer.Address + sizeof(long) + sizeof(long)) != 17453 ||
                        state.StringBuffer.Address[20] != (byte)'e')
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                    ...
                    state.StringBuffer = expires.AllocatedMemoryData.Memory;
                    state.StringSize = expires.Size;
                    aboutToReadPropertyName = true;
                    return true;

                case 23: //Raven-Document-Revision
                    if (*(long*)state.StringBuffer.Address != 8017583188798234962 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long)) != 5921517102558967139 ||
                        *(int*)(state.StringBuffer.Address + sizeof(long) + sizeof(long)) != 1936291429 ||
                        *(short*)(state.StringBuffer.Address + sizeof(long) + sizeof(long) + sizeof(int)) != 28521 ||
                        state.StringBuffer.Address[22] != (byte)'n')
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 24: //Raven-Replication-Source
                    if (*(long*)state.StringBuffer.Address != 7300947898092904786 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long)) != 8028075772393122928 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long) + sizeof(long)) != 7305808869229538670)
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 25: //Raven-Replication-Version OR Raven-Replication-History
                    ...
                    var value = *(long*)(state.StringBuffer.Address + sizeof(long) + sizeof(long));
                    var lastByte = state.StringBuffer.Address[24];
                ...
                case 29: //Non-Authoritative-Information
                    if (*(long*)state.StringBuffer.Address != 7526769800038477646 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long)) != 8532478930943832687 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long) + sizeof(long)) != 7886488383206796645 ||
                        *(int*)(state.StringBuffer.Address + sizeof(long) + sizeof(long) + sizeof(long)) != 1869182049 ||
                        state.StringBuffer.Address[28] != (byte)'n')
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
                ...
                case 30: //Raven-Document-Parent-Revision OR Raven-Document-Revision-Status
                    ...
                    if ((*(long*)(state.StringBuffer.Address + sizeof(long)) != 5777401914483111267 ||
                         *(long*)(state.StringBuffer.Address + sizeof(long) + sizeof(long)) != 7300947924012593761 ||
                         *(int*)(state.StringBuffer.Address + sizeof(long) + sizeof(long) + sizeof(long)) != 1769171318 ||
                         *(short*)(state.StringBuffer.Address + sizeof(long) + sizeof(long) + sizeof(long) + sizeof(int)) != 28271) &&
                        (*(long*)(state.StringBuffer.Address + sizeof(long)) != 5921517102558967139 ||
                         *(long*)(state.StringBuffer.Address + sizeof(long) + sizeof(long)) != 3273676477843469925 ||
                         *(int*)(state.StringBuffer.Address + sizeof(long) + sizeof(long) + sizeof(long)) != 1952543827 ||
                         *(short*)(state.StringBuffer.Address + sizeof(long) + sizeof(long) + sizeof(long) + sizeof(int)) != 29557))
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }

                    var isRevisionStatusProperty = state.StringBuffer.Address[29] == 's';
                    if (reader.Read() == false)
                    {
                ...
                case 32: //Raven-Replication-Merged-History
                    if (*(long*)state.StringBuffer.Address != 7300947898092904786 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long)) != 8028075772393122928 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long) + sizeof(long)) != 7234302117464059246 ||
                        *(long*)(state.StringBuffer.Address + sizeof(long) + sizeof(long) + sizeof(long)) != 8751179571877464109)
                    {
                        aboutToReadPropertyName = true;
                        return true;
                    }
