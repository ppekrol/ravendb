...
{
    internal sealed class ShardedIncomingReplicationHandler : AbstractIncomingReplicationHandler<TransactionContextPool, TransactionOperationContext>
    {
        ...
        internal sealed class ReplicationBatches : IDisposable
        {
