...
{
    internal sealed class ReshardingHandler : ServerRequestHandler
    {
        ...
        internal sealed class ReshardingResult : IOperationResult, IOperationProgress
        {
        ...
        internal sealed class ReshardingOperationDetails : IOperationDetailedDescription
        {
