...
namespace Raven.Server.Documents.Replication
{
    public class ReplicationLoader : IDisposable, ITombstoneAware
    {
        ...
        public void RunPullReplicationAsSink(TcpConnectionOptions tcpConnectionOptions, MemoryBuffer buffer, PullReplicationAsSink destination)
        {
        ...
        public IncomingReplicationHandler CreateIncomingInstance(TcpConnectionOptions tcpConnectionOptions, MemoryBuffer buffer)
        {
        ...
        private ReplicationLatestEtagRequest IncomingInitialHandshake(TcpConnectionOptions tcpConnectionOptions, MemoryBuffer buffer)
        {
