...
namespace Raven.Server.Documents.Replication.Senders
{
    public class FilteredReplicationDocumentSender : ExternalReplicationDocumentSender
    {
        ...
        public FilteredReplicationDocumentSender(Stream stream, OutgoingPullReplicationHandler parent, NLog.Logger log, string[] pathsToSend, string[] destinationAcceptablePaths) : base(stream, parent, log)
        {
