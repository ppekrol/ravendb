...
{
    internal sealed class CollectionOfBloomFilters : IDisposable
    {
        ...
        internal sealed class BloomFilter32 : BloomFilter
        {
        ...
        internal sealed class BloomFilter64 : BloomFilter
        {
    ...
    internal static class BloomFilterVersion
    {
