...
{
    internal sealed class ReduceMapResultsOfStaticIndex : ReduceMapResultsBase<MapReduceIndexDefinition>
    {
        ...
        internal sealed class DynamicIterationOfAggregationBatchWrapper : IEnumerable<DynamicBlittableJson>
        {
