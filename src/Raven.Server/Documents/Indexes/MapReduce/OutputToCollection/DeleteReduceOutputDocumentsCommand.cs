...
{
    internal sealed class DeleteReduceOutputDocumentsCommand : OutputReduceAbstractCommand
    {
    ...
    internal sealed class DeleteReduceOutputDocumentsCommandDto : IReplayableCommandDto<DocumentsOperationContext, DocumentsTransaction, DeleteReduceOutputDocumentsCommand>
    {
