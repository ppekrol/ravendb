...
namespace Raven.Server.Documents.Indexes.Static.TimeSeries
{
    public class MapTimeSeriesIndex : MapIndexBase<MapIndexDefinition, IndexField>
    {
        ...
        {
            return new StaticIndexItemEnumerator<DynamicTimeSeriesSegment>(items, filter: new TimeSeriesItemFilterBehavior(), _compiled.Maps[collection], collection, stats, type);
        }
