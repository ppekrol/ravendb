    ...
    public static async Task<CompleteClusterConfigurationResult> CompleteClusterConfigurationSecuredSetup(CompleteClusterConfigurationParameters parameters)
    {
        try
        {
            ...
            try
            {
                ...
                serverCert = CertificateLoaderUtil.CreateCertificateWithPrivateKey(serverCertBytes, parameters.SetupInfo.Password, CertificateLoaderUtil.FlagsForExport);
            ...
            try
            {
                ...
                clientCert = CertificateLoaderUtil.CreateCertificateWithPrivateKey(certBytes, password: null, flags: CertificateLoaderUtil.FlagsForPersist);
            }
            catch (Exception e)
            {
