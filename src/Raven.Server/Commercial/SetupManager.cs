            ...
            out Dictionary<string, string> otherNodesUrls, out License license, bool isSecured = true)
        {
            ...
            try
            {
                if (isSecured)
                {
                    ...
                    serverCert = CertificateLoaderUtil.CreateCertificateWithPrivateKey(certBytes, certPassword, CertificateLoaderUtil.FlagsForPersist);
                }
            }
            catch (Exception e)
            {
            ...
            try
            {
                if (isSecured)
                {
                    clientCert = CertificateLoaderUtil.CreateCertificateWithoutPrivateKey(clientCertBytes);
                }
            }
            catch (Exception e)
            {
