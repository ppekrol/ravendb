...
namespace Raven.Server.Indexing
{
    public sealed unsafe class LuceneVoronDirectory : Lucene.Net.Store.Directory
    {
        ...
        public LuceneVoronDirectory(Index index, Transaction tx, StorageEnvironment environment, TempFileCache tempFileCache, LuceneIndexInputType indexInputType) 
            : this(index, tx, environment, tempFileCache, "Files", indexInputType)
        { }
