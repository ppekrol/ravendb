...
{
    internal sealed class ServerSmugglerPatcher : SmugglerPatcher
    {
    ...
    internal sealed class DatabaseSmugglerPatcher : SmugglerPatcher
    {
    ...
    internal abstract class SmugglerPatcher
    {
