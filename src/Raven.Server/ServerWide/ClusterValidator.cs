...
{
    internal sealed class ClusterValidator : RachisVersionValidation
    {
    ...
    internal sealed class RejectPutClusterCommandException : Exception
    {
    ...
    internal sealed class RejectSendToFollowerException : Exception
    {
