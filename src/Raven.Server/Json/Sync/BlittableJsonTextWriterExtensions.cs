...
namespace Raven.Server.Json.Sync
{
    internal static class BlittableJsonTextWriterExtensions
    {
        ...
        public static void WriteDocument(this BlittableJsonTextWriter writer, JsonOperationContext context, Document document, Func<LazyStringValue, bool> filterMetadataProperty = null)
        {
            if (document == null)
            {
                writer.WriteNull();
        ...
        private static void WriteDocumentInternal(this BlittableJsonTextWriter writer, JsonOperationContext context, Document document, Func<LazyStringValue, bool> filterMetadataProperty = null)
        {
            writer.WriteStartObject();
