...
{
    internal sealed class DrivesUsage : AbstractDashboardNotification
    {
    ...
    internal sealed class MountPointUsage : IDynamicJson
    {
    ...
    internal sealed class DatabaseDiskUsage : IDynamicJson
    {
