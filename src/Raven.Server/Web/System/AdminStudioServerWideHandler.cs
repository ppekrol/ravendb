...
{
    internal sealed class AdminStudioServerWideHandler : ServerRequestHandler
    {
        ...
        internal sealed class ServerWideTasksResult : IDynamicJson
        {
            ...
            internal abstract class ServerWideTask : OngoingTask
            {
            ...
            internal sealed class ServerWideBackupTask : ServerWideTask
            {
            ...
            internal sealed class ServerWideExternalReplicationTask : ServerWideTask
            {
