        ...
        private class PutConnectionStringCommand : RavenCommand<PutConnectionStringResult>, IRaftCommand
        {
            ...
            public override HttpRequestMessage CreateRequest(JsonOperationContext ctx, ServerNode node, out string url)
            {
                ...
                var request = new HttpRequestMessage
                {
                    ...
                    Content = new BlittableJsonContent(stream => ctx.WriteAsync(stream, DocumentConventions.Default.Serialization.DefaultConverter.ToBlittable(_connectionString, ctx)))
                };
