...
namespace Raven.Client.ServerWide.Operations.Logs
{
    ...
    public class LogsConfiguration : IDynamicJson
    {
    ...
    public class AuditLogsConfiguration : IDynamicJson
    {
        public string Path { get; set; }
    ...
    public class MicrosoftLogsConfiguration : IDynamicJson
    {
        public LogLevel CurrentMinLevel { get; set; }
    ...
    public class AdminLogsConfiguration : IDynamicJson 
    {
        public LogLevel CurrentMinLevel { get; set; }
